...
// ISO 639-1 Language Codes - Complete List
...
// Common languages for quick access (sorted by usage)
export const COMMON_LANGUAGES = ISO_639_1_LANGUAGES.filter(lang =>
  ['en', 'ko', 'ja', 'zh', 'es', 'fr', 'de', 'pt', 'ru', 'ar', 'it', 'nl', 'pl', 'vi', 'th', 'id', 'tr'].includes(lang.code)
);

// Get language by code
export function getLanguageByCode(code: string): Language | undefined {
  return ISO_639_1_LANGUAGES.find(lang => lang.code.toLowerCase() === code.toLowerCase());
}
